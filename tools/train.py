...
def add_path_itp(cfg):
    ...
    if 'vimeo' in cfg.data.train.dataset.lq_folder:
        cfg.data.train.dataset.ann_file = cfg.data.train.dataset.ann_file.replace('//vzhoqiu_azsussc', os.environ['WORKDIR'])
